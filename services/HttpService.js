function makeServiceCall(methodType, url, async = true, data = null) {
    ...
    return new Promise((resolve, reject) => {
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState == 4) {  //if data is null
        ...
        xhttp.open(methodType, url);//GET,POST,PUT,DELETE
        
        // #3 -- Exchanging data with server
        if (data) {
            xhttp.setRequestHeader("Content-Type", "application/json");//If data is present
